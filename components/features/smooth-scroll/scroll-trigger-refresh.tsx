...
import { ScrollTrigger } from "@/utils/gsap/gsap-scroll-trigger";
 ...
 * real layout height changes after that. Preloader
 * (components/features/preloader/preloader.tsx) hides content behind a
 * fixed ~2.55s timer, not an actual
