...
import { gsap } from "@/utils/gsap/gsap-scroll-trigger";
 ...
 * the certifications deck (components/features/card-reveal/pinned-reveal.tsx),
...
export function ScrollPath() {
  ...
  useGSAP(
    () => {
      ...
      // components/features/page-transition/transition-link.tsx: next/link + a
