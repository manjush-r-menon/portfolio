...
interface MarqueePhrasesProps {
  phrases: MarqueeSegment[];
}

function MarqueeText({ phrases }: MarqueePhrasesProps) {
...
function CubeFaces({ phrases }: MarqueePhrasesProps) {
  return (
...
export function ErrorCube({ phrases }: MarqueePhrasesProps) {
