...
import { gsap, ScrollTrigger } from "@/utils/gsap/gsap-scroll-trigger";
import { useGSAP } from "@gsap/react";
import clsx from "clsx";
import { TransitionLink } from "@/components/features/page-transition/transition-link";
...
export function PinnedReveal({ reduced, aboutRef }: PinnedRevealProps) {
