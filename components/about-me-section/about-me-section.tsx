  ...
  return (
    <div className="flex flex-col mt-12">
      ...
      <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
        ...
        code and always stay curious. When I’m not coding, you’ll probably find
        me watching football (always rooting for Argentina and FC Barcelona
        🔵🔴), capturing moments through photography, sketching ideas, or
        experimenting with short film concepts. I'm constantly learning —
        striving to grow both as a developer and a creative.
      </p>
    </div>
  );
};
